...
export const PROJECTS: readonly Project[] = [
  ...
  },
  {
    ...
    story: {
      pt: [
        'api rest de loja escrita em java 21 com spring boot, spring data jpa e h2 em memória, com crud de produtos, categorias e pedidos. o catálogo é paginado e a busca aceita nome e categoria na mesma consulta, com join fetch para trazer as categorias de cada produto sem cair em uma ida ao banco por linha.',
